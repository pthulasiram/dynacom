...
//            return false;
//        }
        return true;//"true".equals(enabled);
    }

    private boolean isMobileRequest(FacesContext facesContext) {
        return false;//isPhoneHomeView(facesContext) || evaluateBooleanRequestScopedExpression(facesContext, "#{userAgent.mobile}");
    }

    private boolean isPhoneHomeView(FacesContext facesContext) {
        return false;//PHONE_HOME_VIEW_ID.equals(facesContext.getViewRoot().getViewId());
    }
